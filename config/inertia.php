...
return [
    ...
    */
    ...
    // Minúscula a propósito: las páginas viven en `resources/js/pages`, y el
    // default del paquete apunta a `js/Pages`. En Windows da igual, pero el CI
    // corre en Linux y ahí las mayúsculas cuentan.
    'page_paths' => [
